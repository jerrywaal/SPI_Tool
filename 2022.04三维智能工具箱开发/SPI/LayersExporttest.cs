...
#region Members
  ...
  /// </summary>
  private void RunScript(List<System.Object> objs, List<string> names, List<string> layers, List<System.Drawing.Color> colors, List<double> pWidths, List<int> wiresEach, List<System.Object> materials, bool activate, bool groupListTgthr)
  {
  ...
  public override void InvokeRunScript(IGH_Component owner, object rhinoDocument, int iteration, List<object> inputs, IGH_DataAccess DA)
  {
    ...
    //2. Assign input parameters
        List<System.Object> objs = null;
    if (inputs[0] != null)
    {
      objs = GH_DirtyCaster.CastToList<System.Object>(inputs[0]);
    }
    List<string> names = null;
    if (inputs[1] != null)
    {
      names = GH_DirtyCaster.CastToList<string>(inputs[1]);
    }
    List<string> layers = null;
    if (inputs[2] != null)
    {
      layers = GH_DirtyCaster.CastToList<string>(inputs[2]);
    }
    List<System.Drawing.Color> colors = null;
    if (inputs[3] != null)
    {
      colors = GH_DirtyCaster.CastToList<System.Drawing.Color>(inputs[3]);
    }
    List<double> pWidths = null;
    if (inputs[4] != null)
    {
      pWidths = GH_DirtyCaster.CastToList<double>(inputs[4]);
    }
    List<int> wiresEach = null;
    if (inputs[5] != null)
    {
      wiresEach = GH_DirtyCaster.CastToList<int>(inputs[5]);
    }
    List<System.Object> materials = null;
    if (inputs[6] != null)
    {
      materials = GH_DirtyCaster.CastToList<System.Object>(inputs[6]);
    }
    bool activate = default(bool);
    if (inputs[7] != null)
    {
      activate = (bool)(inputs[7]);
    }

    bool groupListTgthr = default(bool);
    if (inputs[8] != null)
    {
      groupListTgthr = (bool)(inputs[8]);
    }
    ...
    //4. Invoke RunScript
    RunScript(objs, names, layers, colors, pWidths, wiresEach, materials, activate, groupListTgthr);
