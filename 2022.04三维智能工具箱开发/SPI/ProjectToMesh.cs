...
namespace SPI
{
    public class ProjectToMesh : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ProjectToMesh()
          : base("ProjectToMesh", "PToM",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (Curve C in OC)
            {
                foreach (Mesh M in OM)
                {
                    ...
                    {
                        Curve[] PC = Curve.ProjectToMesh(C, M, V, 0.01);
                        DA.SetDataList(0, PC);
                    }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Icon.ProjectToMesh;
            }
        }
        ...
        /*public override GH_Exposure Exposure
        {
            get
            {
                return GH_Exposure.obscure | GH_Exposure.secondary;
            }
        }*/
    }
}